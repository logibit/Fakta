...
//      Async.RunSynchronously (Session.renewPeriodic state (Duration.FromSeconds 10L) sessionId [] (Duration.FromSeconds 30L))
    ...
    testCaseAsync "get list of" <| async {
    ...
    testCaseAsync "get list of, for a node" <| async {
    ...
    testCaseAsync "create, no heathchecks" <| async {
